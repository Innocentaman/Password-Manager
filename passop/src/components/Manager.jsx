                    ...
                    <div className='flex flex-col md:flex-row w-full justify-between gap-8'>
                        ...
                        <div className="relative">
                            ...
                            <span className='absolute right-1 cursor-pointer' onClick={showPassword}>
                                <img ref={ref} width={32} src="icons/eye.png" alt="eye" />
                            </span>
                        </div>
                    </div>
                    <button onClick={savePassword} className='flex  justify-center items-center gap-2 hover:bg-green-300 bg-green-400 rounded-full px-8 py-2 w-fit border border-green-900'>
                        <lord-icon
